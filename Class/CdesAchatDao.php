...
class CdesAchatDao{
	...
	public function insertInfos($idEncours, $date, $qte,$cmt){
		$week=null;
		if($date!=null){
			$week=(new DateTime($date))->format('W');
		}
		$req=$this->pdo->prepare("INSERT INTO cdes_infos (id_encours, date_previ, week_previ, qte_previ, cmt, date_insert, id_web_user) VALUES (:id_encours, :date_previ, :week_previ, :qte_previ, :cmt, :date_insert, :id_web_user)");
		$req->execute([
