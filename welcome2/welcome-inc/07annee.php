		...
		<div class="col">
			<div class="d-flex justify-content-between">
				...
				<div class="secondary-text text-right pr-5">
					...
					<br><span class="norm-text-abs" style="margin-top: -15px;"><?=number_format((float)$anneeEnCoursLastYearPalettes,0,'', ' ')?> palettes  pour <?=number_format((float)$anneeEnCoursLastYearColis,0,'', ' ')?> colis</span>
				</div>
			</div>
		</div>
	</div>