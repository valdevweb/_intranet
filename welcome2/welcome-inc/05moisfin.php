	...
	<div class="row">
		<div class="col">
			<div class="d-flex justify-content-between">
				...
				<br><span class="norm-text-abs" style="margin-top: -15px;"><?=number_format((float)$moisFinLastYearPalettes,0,'', ' ')?> palettes  pour <?=number_format((float)$moisFinLastYearColis,0,'', ' ')?> colis</span>
