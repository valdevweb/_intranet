	...
	<div class="col">
		<div class="d-flex justify-content-between ">
			...
			<div class="secondary-text align-items-end align-self-end text-right pr-3 shadow-text txt-bg">
				<?= number_format((float)$endMonthDiff,0,'',' ')?><span class="third-text">&euro;</span>

			</div>
		</div>
		<div class="d-flex justify-content-between my-3">
			<i class="fas <?= $icoEndMonth?> third-text align-items-end align-self-end pb-2 pl-5"></i>
			<div class="third-text align-items-end align-self-end text-right pr-3 shadow-text txt-bg"><?= round($endMonthPer,2)?><span class="norm-text">%</span><br></div>
		</div>
