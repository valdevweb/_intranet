...
$sheet->setCellValue('E1', 'PAF unitaire -60%');
$sheet->setCellValue('F1', 'Prix de vente conseillé occasion TTC');
$sheet->setCellValue('G1', 'Taux de marge magasin');
$sheet->setCellValue('H1', 'Article BT');
$sheet->setCellValue('I1', 'Palette contremarque');
$row=2;
...
foreach ($articles as $key => $art) {
	...
	$sheet->setCellValue('H'.$row,  $art['article']);
	$sheet->setCellValue('I'.$row,  $art['palette']);
	$row++;
}
...
$xlFile='occasion/fichier-occasion-'.date('YmdHis').'.xlsx';
