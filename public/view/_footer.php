 ...
 <p class="logo-footer"> <img src="<?= $img ?>footer/eleclercblue.jpg"></p>
        ...
        <div class="col l4 s12">
          <h5 class="white-text">Nous contacter</h5>
            ...
            <p><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp; &nbsp;&nbsp;<a class="white-text" href="">Envoyer un mail à BTlec</a>

        </div>
        <div class="col l4 s12">
          <h5 class="white-text">Plus d'infos</h5>
          <p>
            <i class="fa fa-globe" aria-hidden="true"></i>&nbsp; &nbsp;<a class="white-text" href="<?= $map ?>">Venir à BTlec</a>
          </p>
