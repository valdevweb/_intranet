				...
				<?php if ($dBtlec || $dLitigeBt): ?>
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="nav-litige-bt">
							...
							<li><a  class="dropdown-item" href="<?=ROOT_PATH?>/public/litiges/intervention-commission-sav.php">Retour Commission SAV</a></li>
							<li><a  class="dropdown-item" href="<?=ROOT_PATH?>/public/litiges/intervention-sav.php">Retour SAV</a></li>
							<li><a  class="dropdown-item" href="<?=ROOT_PATH?>/public/litiges/intervention-achats.php">Retour Service achats</a></li>
