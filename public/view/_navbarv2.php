...
<div id='cssmenu'>
	<ul>
			...
			<li><a href="<?= ROOT_PATH. '/public/entrepot/discover.php'?>" data-toggle="tooltip" data-html="true" title="visitez l'entrepot"><span>Entrepôt</span></a></li>
		...
		<?php
		 ...
		 ?>
			...
			<li><a href="http://172.30.92.53/scapsav/intranet/magasin.php" data-toggle="tooltip" data-html="true" title="aller sur le site scapsav">Site Scapsav</a></li>
			...
			<!-- profile -->
			<li><a href='<?= ROOT_PATH?>/public/user/profil.php' data-toggle="tooltip" data-html="true" title="Votre compte"><span><i class="fa fa-user"></i></span></a></li>
			<li><a href="<?= ROOT_PATH ?>/public/logoff.php" data-toggle="tooltip" data-html="true"  title="se déconnecter"><i class="fa fa-power-off"></i></a></li>
	 </ul>
