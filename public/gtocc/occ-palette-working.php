				...
				<div class="col text-right mr-2">
					<div class="cart-toggle position-relative">
						<a href="#" id="cart">
							...
							<div class='cart-wrapper'><span id='cart-count'><?=$nbTempPalette?></span></div>
						</a>
					</div>
				</div>
			</div>
					...
					<div class="shopping-cart shadow hidden">
						<div class="shopping-cart-header">
							...
							<div class="shopping-cart-total">
								...
								<span class="text-danger font-weight-bold"><?=$nbTempPalette?></span>
							</div>
						</div> <!--end shopping-cart-header -->

						<div class="shopping-cart-items">
							<?php foreach ($listTempPalette as $key => $tempPalette): ?>
