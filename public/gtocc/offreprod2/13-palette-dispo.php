	...
	<?php if (!empty($paletteCommandable)): ?>
		...
		<div class="row my-3">
			<div class="col">
				<a href="#<?=$palette[0]['id_palette']?>" id="<?=$palette[0]['id_palette']?>" class="btn-detail-palette" data-palette-id="<?=$palette[0]['id_palette']?>">Palette <?=$palette[0]['palette'] ?> - voir le detail</a>
			</div>
		</div>

		<div class="row detail-palette" data-palette-detail="<?=$palette[0]['id_palette']?>" >
			<div class="col">
				<div class="row pb-2">
					<div class="col-1"></div>
					<div class="col">
		...
		<div class="row">
			<div class="col text-right">Montant total : <?=number_format((float)($montantPalette),2,'.', ' ');?>&euro;</div>
		</div>
