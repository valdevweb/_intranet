...
function getPalette($pdoOcc,$id){
	$req=$pdoOcc->prepare("SELECT palettes_articles.*, palettes.palette, statut  FROM palettes_articles LEFT JOIN palettes ON palettes_articles.id_palette=palettes.id
