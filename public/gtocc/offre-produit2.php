...
if(isset($_POST['addtocart'])){
	include 'offreprod2/01-add-palette-to-cart.php';
}
...
include 'offreprod2/02-add-article-to-cart.php';
include 'offreprod2/03-checkout.php';
...
<div class="container">
	...
	if (!empty($paletteEtArticleDansPanier)){
		include 'offreprod2/10-cart.php';
	}
	?>
	<div class="row mt-3">
	...
	include 'offreprod2/11-article-qlik.php';
	// affich&age palettes en prepa pour bt
	if ($_SESSION['type']=='btlec'){
		include 'offreprod2/12-bt-palette-enprepa.php';
	}
	// affichage palette terminées pour tout le monde



	include 'offreprod2/13-palette-dispo.php';
	// affichage palettes commandéew et expédiées
	if ($_SESSION['type']=='btlec'){
		include 'offreprod2/14-bt-palette-cdees.php';
...
<script type="text/javascript">
	$( document ).ready(function() {
		...
		// });
			...
			$('.btn-detail-palette').on("click", function(){
			var id= $(this).data("palette-id");
			if($('.detail-palette[data-palette-detail="'+id+'"]').is(":visible")){
				$('.detail-palette[data-palette-detail="'+id+'"]').hide();


			}else{
				$('.detail-palette[data-palette-detail="'+id+'"]').show();
				console.log("id" +id);
