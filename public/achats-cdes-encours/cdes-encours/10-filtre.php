	...
	<div class="row">
		<div class="col-6">
			...
			<div class="row">
			  <div class="col">
				<div class="form-group">
				  <label for="codelec">Codelec :</label>
				  <input type="text" class="form-control form-primary" name="codelec" id="codelec" value="<?= isset($_SESSION['encours_filter']['codelec']) ? FormHelpers::restoreValue($_SESSION['encours_filter']['codelec']) : "" ?>">
				</div>
			  </div>
			</div>		
		</div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="row mb-3">
						...
						<div class="col">
							<div class="form-group">
								<input type="text" class="form-control form-primary" name="ref" id="ref" placeholder="reférence" value="<?= isset($_SESSION['encours_filter']['ref']) ? FormHelpers::restoreValue($_SESSION['encours_filter']['ref']) : "" ?>">
							</div>
						</div>
					</div>
				</div>
