	...
	<div class="row">
		<div class="col">
			<?php if (!empty($relancesOne)): ?>
				<?php include 'encours-relances/10-table-relances-un.php' ?>
				<?php else: ?>
		...
		<div class="row">
			<div class="col">
				<?php if (!empty($relancesOne)): ?>
					<?php include 'encours-relances/11-table-relances-deux.php' ?>
					<?php else: ?>
						<div class="alert alert-info">Aucune relance à afficher. Vérifiez que la sélection des GTs est correcte</div>
					<?php endif ?>
				</div>
			...
			<div class="row">
				<div class="col">
					<?php if (!empty($relancesPerm)): ?>
						<?php include 'encours-relances/12-table-relances-perm.php' ?>
						<?php else: ?>
							<div class="alert alert-info">Aucune relance à afficher. Vérifiez que la sélection des GTs est correcte</div>
						<?php endif ?>
					</div>
