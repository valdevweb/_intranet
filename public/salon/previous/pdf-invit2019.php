...
<body>
	...
	<table>
		<tr>
			<td><h1><span class="text-prim"><?=$invit['genre'] .' '.$invit['prenom'].' ' .$invit['nom']?> </span></h1></td>
		</tr>
	</table>
	<div class="spacing-l"></div>
	...
	<table class="">
		<tr>
			<td class="full-width text-center"><h1 class="text-center">Votre invitation au salon BTlec</h1></td>
		</tr>
		<tr>
			<td class="full-width text-center"><img src="../img/salon/salon2019_5.png"></td>
		</tr>
		<tr>
			<td class="bigger text-center text-prim">Mardi 4 juin 2019 : 9h30 - 17h30 <br>et<br>Mercredi 5 juin 2019 : 9h00 - 16h30</td>
		</tr>
	</table>
<div class="spacing-l"></div>
	...
	<table>
		<tr>
		<td class="quatre"></td>
		<td class="deux padding-table border-table text-center bg-sec text-white border-table-sec">
			<p class="normal  "><strong>PROGRAMME 2019 : </strong></p>
		</td>
		<td class="quatre"></td>
	</tr>
	<tr>
		...
		<td class="deux padding-table">
			<p class="normal"><strong>Mardi 4 juin :</strong><br>
	...
	<tr>
		...
		<td class="deux padding-table">
			...
			<p class="normal"><strong>Mercredi 5 juin :</strong><br>
				- 9h30 : Convention</p>
		</td>
		<td class="quatre"></td>
	</tr>
