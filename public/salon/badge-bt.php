...
<body>
	...
	<div class="main-center">
		<?php foreach ($users as $key => $participant): ?>
					...
					<table class="full-size no-border" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td  class="full-size text-center text-secondary">
								<h3>
									<?php if ($participant['service']!="" && $participant['service']!='NULL'): ?>
						...
						<tr>
							<td class="full-size text-center">Salon et convention BTlec Est 2021</td>
						</tr>
