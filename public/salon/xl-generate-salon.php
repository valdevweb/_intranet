...
$sheet->setCellValue('E1', 'Mardi');
$sheet->setCellValue('F1', 'Repas mardi');
$sheet->setCellValue('G1', 'Mercredi');
$sheet->setCellValue('H1', 'Repas mercredi');
$row=2;
$nbMardi=0;
$nbRepasMardi=0;
$nbMercr=0;
...
foreach ($participantList as $part)
{
	...
	$sheet->setCellValue('E'.$row, $part['mardi']);
	$sheet->setCellValue('F'.$row, $part['repas_mardi']);
	$sheet->setCellValue('G'.$row, $part['mercredi']);
	$sheet->setCellValue('H'.$row, $part['repas_mercredi']);
	...
	$sheet->setCellValue('E'.$row, $nbMardi);
	$sheet->setCellValue('F'.$row, $nbRepasMardi);
	$sheet->setCellValue('G'.$row, $nbMercr);
	$sheet->setCellValue('H'.$row, $nbRepasMercr);
