...
{
	$req=$pdoBt->prepare("SELECT mag, salon_2020.galec, sca3.btlec, centrale, nom, prenom, fonction, DATE_FORMAT(date_saisie,'%d-%m-%Y') as datesaisie, mardi, mercredi,repas_mardi, repas_mercredi FROM salon_2020
...
header('Content-Disposition: attachment; filename="participants salon 2020.xlsx"');
