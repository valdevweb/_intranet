...
{
	$req=$pdoBt->query("SELECT * FROM btlec LEFT JOIN services ON btlec.id_service= services.id  WHERE rep='oui' ORDER BY id_service");
			...
			<table class="table table-striped">
				 <thead class="thead-dark">
    				...
    				<?php foreach($data as $contact){
    					echo '<tr><td>'.$service =($contact['full_name']=='litiges livraison') ? 'responsable entrepôt' : $contact['full_name'] .'</td>';
