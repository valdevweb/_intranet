...
function copyDetail($pdoLitige,$numDossier){
	$req=$pdoLitige->prepare("INSERT INTO details( id_dossier, dossier, palette, facture, date_facture, article, gt, ean, serials, dossier_gessica, descr, qte_cde, tarif, puv, pul, fournisseur, cnuf, qte_litige, box_tete, box_art, occ_article_palette, id_reclamation, inv_palette, inversion, inv_article, inv_qte, inv_descr, inv_tarif, valo_line, inv_fournisseur, etat_detail, pj, ctrl_ko, ecart, mvt, date_ctrl) SELECT  id_dossier, dossier, palette, facture, date_facture, article, gt, ean, serials, dossier_gessica, descr, qte_cde, tarif, puv, pul, fournisseur, cnuf, qte_litige, box_tete, box_art, occ_article_palette, id_reclamation, inv_palette, inversion, inv_article, inv_qte, inv_descr, inv_tarif, valo_line, inv_fournisseur, etat_detail, pj, ctrl_ko, ecart, mvt,date_ctrl FROM details_temp WHERE details_temp.dossier= :dossier");
	$req->execute([
		':dossier'	=>$numDossier
	]);
	return $req->rowCount();
