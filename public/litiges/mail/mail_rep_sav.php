  <html>
    ...
    <body style="font-family:arial,helvetica, 'sans serif'; color:dimGray;">
        <p>Bonjour,</p>
        <p>Le SAV a répondu à votre demande sur le dossier litige <span style="color:firebrick;"><b>{DOSSIER}</b></span> du magasin <span style="color:firebrick;"><b>{MAG}</b></span>.<br> </p>
        <p>&nbsp;</p>
         <p><b>Réponse du SAV :</b></p>
